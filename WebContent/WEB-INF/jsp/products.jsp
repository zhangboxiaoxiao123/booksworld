    ...
    <body>
        ...
        <div class="navbar navbar-inverse">
            <div class="navbar-inner">
                ...
                <a class="brand" href="index.html" style="font-weight:700;font-family:Microsoft Yahei">及时行乐-商品列表</a>
        ...
        <div id="sidebar-nav">
            <ul id="dashboard-menu">
				...
				<li>
                    <a class="dropdown-toggle" href="${pageContext.request.contextPath}/add">
                        <span>添加商品</span>
                    </a>
                </li>
                <li>
                ...
                <div id="pad-wrapper" class="users-list">
                    <div class="row-fluid header">
                        ...
                        <div class="span10 pull-right">
                            <a href="add.html" class="btn-flat success pull-right">
                   ...
                   <input type="button" value="删除" class="align-right" onclick="document.form1.action='${pageContext.request.contextPath}/admincommoditydelete';document.form1.submit();">
                   <input type="button" value="修改" class="align-right" onclick="document.form1.action='${pageContext.request.contextPath}/productupdate';document.form1.submit();">
                        </form>
                    </div>
