    ...
    <body>
        ...
        <div class="navbar navbar-inverse">
            <div class="navbar-inner">
                ...
                <a class="brand" href="index.html" style="font-weight:700;font-family:Microsoft Yahei">及时行乐-评论</a>
                ...
                <div id="pad-wrapper" class="users-list">
                    ...
                    <div class="row-fluid table">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th class="span3 sortable">
                                        <span class="line"></span>评论ID</th>
                                    <th class="span3 sortable">
                                        <span class="line"></span>评论时间</th>
                                    <th class="span3 sortable">
                                        <span class="line"></span>用户ID</th>
                          			<th class="span3 sortable">
                                        <span class="line"></span>产品ID</th>
                            ...
                            <tbody>
                                <!-- row -->
								<c:forEach var="CommentList" items="${cli}">
                                <tr class="first">
								<td>${CommentList.PID}</td>
                                <td>${CommentList.PDate}</td>
                                <td>${CommentList.UID}</td>
                                <td>${CommentList.CID}</td>
                                <td>${CommentList.PContent}</td>
                                <td><a href="requir.html">回复</a></td>
                                </tr>
                                </c:forEach>
                            </tbody>
                        </table>
