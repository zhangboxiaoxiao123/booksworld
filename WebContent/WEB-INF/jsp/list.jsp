                    ...
                    <div class="row-fluid table">
                       <form name="form1" id="form1" method="post">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th class="span3 sortable">
                                        <span class="line"></span>订单ID</th>
                                    <th class="span2 sortable">
                                        <span class="line"></span>用户姓名</th>
                                    <th class="span3 sortable">
                                        <span class="line"></span>手机号</th>
                          			<th class="span3 sortable">
                                        <span class="line"></span>商品名称</th>
                                    <th class="span2 sortable">
                                        <span class="line"></span>商品数量</th>
                                    <th class="span3 sortable">
                                        <span class="line"></span>订单时间</th>
                                    <th class="span3 sortable">
                                        <span class="line"></span>用户地址</th>
                                    <th class="span2 sortable align-right">
                                        <span class="line"></span>图书类型</th>
                                     <th class="span3 sortable">
                            ...
                            <tbody>
                                <!-- row -->
								<c:forEach var="OrderList" items="${adminol}">
                                <tr class="first">
								<td>${OrderList.oid}</td>
                                <td>${OrderList.uname}</td>
                                <td>${OrderList.uphone}</td>
                                <td>${OrderList.cname}</td>
                                <td>${OrderList.cnumber}</td>
                                <td>${OrderList.odate}</td>
								<td>${OrderList.uaddress}</td>
								<td>${OrderList.ctype}</td>
								<td><input type="checkbox" name="ids" value="${OrderList.oid}"></td>
                                </tr>
                                </c:forEach>
                            </tbody>
                        </table>
                        <div>
                        <input class="btn-flat success pull-right" type="button" value="删除" onclick="document.form1.action='${pageContext.request.contextPath}/orderdelete';document.form1.submit();">
                        </div>
                        <div>
                        <input class="btn-flat success pull-right" type="button" value="修改" onclick="document.form1.action='${pageContext.request.contextPath}/orderupdate';document.form1.submit();">
                        </div>
                        </form>
                    </div>
