    ...
    <body>
        ...
        <div class="navbar navbar-inverse">
            <div class="navbar-inner">
                ...
                <a class="brand" href="index.html" style="font-weight:700;font-family:Microsoft Yahei">及时行乐 - 后台管理</a>
                        ...
                        <div class="span9 with-sidebar">
                            <div class="container">
                                <form id="w0" class="new_user_form inline-input" action="/index.php?r=admin%2Fmanage%2Fchangeemail" method="post">
									...
									<div class="form-group field-admin-adminpass">
                                        <div class="span12 field-box">
                                            <label class="control-label" for="admin-adminpass">确认管理员密码</label>
                                            <input type="password" id="admin-adminpass" class="span9" name="Admin[adminpass]" value=""></div>
                                        <p class="help-block help-block-error"></p>
                                    </div>
                                    <div class="form-group field-admin-adminemail">
                                        <div class="span12 field-box">
                                            ...
                                            <input type="text" id="admin-adminemail" class="span9" name="Admin[adminemail]" value="704645140@qq.com"></div>
                                        <p class="help-block help-block-error"></p>
                                    </div>
