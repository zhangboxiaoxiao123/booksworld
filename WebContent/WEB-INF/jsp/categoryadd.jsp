    ...
    <body>
        ...
        <div class="navbar navbar-inverse">
            <div class="navbar-inner">
                ...
                <a class="brand" href="../default/index.html" style="font-weight:700;font-family:Microsoft Yahei">及时行乐-分类管理</a>
                        ...
                        <div class="pop-dialog">
                            ...
                            <div class="body">
                                ...
                                <div class="notifications">
                                    <h3>你有 6 个新通知</h3>
                                    <a href="#" class="item"> <em class="icon-signin"></em>新用户注册 <span class="time"> <em class="icon-time"></em>13 分钟前.</span></a> <a href="#" class="item"> <em class="icon-signin"></em>新用户注册 <span class="time"> <em class="icon-time"></em>18 分钟前.</span></a> <a href="#" class="item"> <em class="icon-signin"></em>新用户注册 <span class="time"> <em class="icon-time"></em>49 分钟前.</span></a> <a href="#" class="item"> <em class="icon-download-alt"></em>新订单 <span class="time"> <em class="icon-time"></em>1 天前.</span></a>
                                    <div class="footer">
        ...
        <div id="sidebar-nav">
            <ul id="dashboard-menu">
                ...
                <li>
                    <a class="dropdown-toggle" href="cates.html">
						<div class="pointer">
                        <div class="arrow"></div>
                        <div class="arrow_border"></div>
                    </div>
                ...
                <div id="pad-wrapper" class="new-user">
                    ...
                    <div class="row-fluid form-wrapper">
                        ...
                        <div class="span9 with-sidebar">
                            <div class="container">
                                <form id="w0" class="new_user_form inline-input" action="cates.html" method="post">
                                    ...
                                    <div class="form-group field-category-title required">
                                        <div class="span12 field-box">
                                            ...
                                            <input type="text" id="category-title" class="span9" name="Category[title]" placeholder="次级分类名"></div>
                                        <p class="help-block help-block-error"></p>
                                    </div>
