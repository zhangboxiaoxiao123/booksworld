...
<nav class="top-bar animate-dropdown">
    <div class="container">
        ...
        <div class="col-xs-12 col-sm-6 no-margin">
            <ul class="right">
                <li><a href="${pageContext.request.contextPath}/authentication">注册</a></li>
                <li><a href="${pageContext.request.contextPath}/authentication">登录</a></li>
            </ul>
        </div><!-- /.col -->
    </div><!-- /.container -->
</nav><!-- /.top-bar -->
...
<div class="search-area">
    <form >
        <div class="control-group">
            <input class="search-field" id = "cname" type = "text" size = 20 />
              
		<input type = "radio" id = "cname" name = "cname">书名
		<input type = "radio" id = "ctype" name = "ctype">类型
		<input type = "radio" id = "cprice" name = "cprice">价格
		<a style="padding:15px 15px 13px 12px" class="search-button" href="${pageContext.request.contextPath}/cname" ></a>  
        </div>
    </form>
</div><!-- /.search-area -->
