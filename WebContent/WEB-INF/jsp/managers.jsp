    ...
    <body>
        ...
        <div class="navbar navbar-inverse">
            <div class="navbar-inner">
                ...
                <a class="brand" href="../default/index.html" style="font-weight:700;font-family:Microsoft Yahei">及时行乐-后台管理</a>
        ...
        <div id="sidebar-nav">
            <ul id="dashboard-menu">
                ...
                <li>
                    <a class="dropdown-toggle" href="managers.html">
					<div class="pointer">
                        <div class="arrow"></div>
                        <div class="arrow_border"></div>
                    </div>
				...
				<li>
                    <a class="dropdown-toggle" href="${pageContext.request.contextPath}/reg">
                        <span>添加管理员</span>
                    </a>
                </li>
				<li>
                    <a class="dropdown-toggle" href="${pageContext.request.contextPath}/changeemail">
                        <span>管理员信息</span>
                    </a>
                </li>
                <li>
                    <a class="dropdown-toggle" href="${pageContext.request.contextPath}/user">
                ...
                <div id="pad-wrapper" class="users-list">
                    <div class="row-fluid header">
                        ...
                        <div class="span10 pull-right">
                            <a href="${pageContext.request.contextPath}/reg" class="btn-flat success pull-right">
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="span2">
                                        <span class="line"></span>管理员名字</th>
                                    <th class="span2">
                                        <span class="line"></span>管理员地址</th>
                                    <th class="span3">
                                        <span class="line"></span>邮编</th>
                                    <th class="span3">
                                        <span class="line"></span>联系方式</th>
                                    <th class="span2">
                            ...
                            <tbody>
                            <c:forEach var="manager" items="${adminma}">
                                <tr>
                                    <td>${manager.uid}</td>
                                    <td>${manager.uname}</td>
                                    <td>${manager.uaddress}</td>
                                    <td>${manager.uzip}</td>
                                    <td>${manager.uphone}</td>
                                    <td>${manager.birthday}</td>
                                    <td class="align-right">
                                         <input type="checkbox" name="id" value="${manager.uid}" />
                               </tr>
                               </c:forEach>
                            </tbody>
                        </table>
                        <input   class="btn-flat success pull-right" type="button" value="删除" class="align-right" onclick="document.form1.action='${pageContext.request.contextPath}/admindelete';document.form1.submit();">
                        </form>
                    </div>
