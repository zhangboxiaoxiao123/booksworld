    ...
    <body>
        ...
        <div class="navbar navbar-inverse">
            <div class="navbar-inner">
                ...
                <a class="brand" href="../comment/list.html" style="font-weight:700;font-family:Microsoft Yahei">及时行乐-订单管理</a>
        ...
        <div id="sidebar-nav">
            <ul id="dashboard-menu">
                ...
                <li>
                    <a class="dropdown-toggle" href="${pageContext.request.contextPath}/manage">
                        <i class="icon-user"></i>
                        <span>管理员管理</span>
				...
				<li>
                    <a class="dropdown-toggle" href="send.html">
						 <div class="pointer">
                        <div class="arrow"></div>
                        <div class="arrow_border"></div>
                    </div>
                ...
                <div id="pad-wrapper" class="new-user">
                    ...
                    <div class="row-fluid form-wrapper">
                        ...
                        <div class="span9 with-sidebar">
                            <div class="container">
                                <form id="w0" class="new_user_form inline-input" action="list.html" method="post">
