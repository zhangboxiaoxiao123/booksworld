...
<div class="control-group">
            ...
            <a style="padding:15px 15px 13px 12px" class="search-button" href="#" name="CName"></a>    
...
<table style="width:100%;border-collapse:collapse;border-spacing:0px;">
  <colgroup>
        ...
        <tbody>
		<label>
                <strong title="Data" style="margin-right:8px;font-weight:bold;">
                  ${USER_SESSION.uname}
                </strong>
              </label>
          	<tr>
